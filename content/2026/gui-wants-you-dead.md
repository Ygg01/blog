...
To this my answer is as follows: That's true for any X that's not JavaScript and any toolkit not called Electron. Maybe Tauri. 
...
To be fair, Apple fanboys have been a bit quieter since [Liquid Ass](https://en.wikipedia.org/wiki/Liquid_Glass)[^1] came out, but before they would complain if an app wasn't jibing well with the rest of the apps.
...
The moment Unicode was created, there was a sound of thousand GUI programmers crying in unison. Not only does it lead to [[#Font rendering]] but it also causes issues when localizing cross languages.
...
So to answer [[#The question]]. A language isn't good cross platform GUI because it isn't backed by several mega corps expressly for the purpose of making UIs. You have decades of hardware and software backwards-compatibility to look forward to, platforms hostile to your existence, users expecting localizations, widgets, scripting, debugging, visual editor, documentation, etc. Not to mention the 
