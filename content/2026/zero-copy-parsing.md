...
In Rust, a `str` is a view into an array of UTF-8 bytes like so:![[zc_string.png]]*Behold a string!*
...
![[zc_slices.png]]*Final form of Zero-Copying: Pointer + Length*
...
![[zc_lazy.png]]*The success of being lazy*
...
![[zc_inplace_edit.png]]*We heard you like editing strings*
