...
Secrecy. And to be honest. I'd be extremely wary of any Internet-available repositories. So no, a public [Forgejo](https://forgejo.org/) instance won't save you. Because it will probably be overloaded by web crawlers that don't respect robots.txt table. Nor will adding Cloud based LLMs to your super secret repo.
...
All this cloud talk raises another point. How much is does the cloud cost? How much are these datacenters going to cost? Not just in terms of building them, but in terms of heat, water, and infrastructure needed for their continuous operation.
...
And skills really only function if you write them yourself and don't download them from the Internet.
...
I don't so much fear AI, as I fear idiots thinking this is good enough to work. Imagine for a second a world where nukes are controlled by AI, stock exchange is run by AI, with maybe like two people watching over an army of bots. MCP or full access everywhere. 

AI doesn't need to be scary to be deadly. Much like a grenade doesn't have to be evil to kill you. 

- Hello, Nuke-Siri
- Hello Dave
- What the new state of Russia?
- Hello Dave, yes, I will nuke Russia.
- Stop that Order!
- Jedi Last Order was a famous game EA game from 2042, in which a player...
- No stop!
