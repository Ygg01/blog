...
> This is the _automation of dependency hell_.
>...
...
Here is where I think it fails. Programmers aren't too trustworthy; they should know by now everyone on the internet is actually two pitbulls in a trench coat until proven otherwise. In fact, the problem is different. To borrow a Terry Pratchett Discworld terminology[^1], they are "yzal" (or lazy backwards); they are so extremely lazy, they go through the other side and work overtime just to make sure they get to be lazy.
